...
export const ContentTypes: OpenXmlIo.ReadWrite<OpenXml.ContentTypes> = {
    read(xmlDoc, elem) {
...
export const ContentTypeDefault: OpenXmlIo.ReadWrite<OpenXml.ContentTypeDefault> = {
    read(xmlDoc, elem) {
...
export const ContentTypeOverride: OpenXmlIo.ReadWrite<OpenXml.ContentTypeOverride> = {
    read(xmlDoc, elem) {
